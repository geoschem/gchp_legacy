!  $Id: MAPL_Cap.F90,v 1.37.12.4.14.7.2.1.4.1 2014-07-31 18:25:53 jkouatch Exp $
...
!-----------------
   ...
   ! Add NX and NY from AGCM.rc to ExtData.rc
   ...
   ! ---------------------------
       ...
       DO I=1, ITEMCOUNT
          if(ItemTypes(I) == ESMF_StateItem_Field) then
             ...
             VERIFY_(STATUS)
!KNJR 31July2014          else if(ItemTypes(I) == ESMF_StateItem_FieldBundle) then
!KNJR 31July2014             call ESMF_StateGet(IMPORTS(ROOT), ItemNames(i), bundle, rc=status)
!KNJR 31July2014             VERIFY_(STATUS)
!KNJR 31July2014             call MAPL_StateAdd(EXPORTS(EXTDATA), bundle, rc=status)
!KNJR 31July2014             VERIFY_(STATUS)
          end if
       END DO
