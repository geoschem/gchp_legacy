...
! benefit and could be done as a second step anyway, if necessary.
 ...
 character(len=128), parameter :: version = '$Id: sat_vapor_pres_k.F90,v 1.1.1.2 2012-11-16 16:00:10 atrayano Exp $'
 character(len=128), parameter :: tagname = '$Name: jk-G40-GEOSctm-advcore-update3 $'
