! $Id: drifters_core.F90,v 1.1.1.1 2010-03-19 21:18:54 atrayano Exp $
!
...
module drifters_core_mod
  ...
  character(MAX_STR_LEN), parameter, private :: version = '$Id: drifters_core.F90,v 1.1.1.1 2010-03-19 21:18:54 atrayano Exp $'
