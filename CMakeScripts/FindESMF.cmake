...
find_package_handle_standard_args(ESMF 
	REQUIRED_VARS ESMF_INSTALL ESMF_HEADERS ESMF_INCLUDES ESMF_MODULES ESMF_LIBRARY_DIR
	FAIL_MESSAGE "Cannot find the ESMF includes and libraries!\nSet ESMF_INSTALL\n"
)

mark_as_advanced(ESMF_INSTALL)
set(ESMF_INCLUDE_DIRS ${ESMF_INCLUDES} ${ESMF_HEADERS} ${ESMF_MODULES})
