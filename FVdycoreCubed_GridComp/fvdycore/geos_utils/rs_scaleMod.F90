...
contains
   ...
   subroutine scale_drymass(FVAtm,rc)
...
! **********************************************************************
      ...
      qv = fvatm(1)%q(is:ie,js:je,:,1)
      qlls = fvatm(1)%q(is:ie,js:je,:,2)
      qlcn = fvatm(1)%q(is:ie,js:je,:,3)
      cfls = fvatm(1)%q(is:ie,js:je,:,4)
      cfcn = fvatm(1)%q(is:ie,js:je,:,5)
      qils = fvatm(1)%q(is:ie,js:je,:,6)
      qicn = fvatm(1)%q(is:ie,js:je,:,7)
...
1001     format(1x,'PSDRY_NEW: ',g21.14,'  PSDRY_OLD: ',g21.14,'  RATIO: ',g25.18,'  DIF: ',g21.14)
      ...
      fvatm(1)%q(is:ie,js:je,:,1) = qv
      fvatm(1)%q(is:ie,js:je,:,2) = qlls
      fvatm(1)%q(is:ie,js:je,:,3) = qlcn
      fvatm(1)%q(is:ie,js:je,:,4) = cfls
      fvatm(1)%q(is:ie,js:je,:,5) = cfcn
      fvatm(1)%q(is:ie,js:je,:,6) = qils
      fvatm(1)%q(is:ie,js:je,:,7) = qicn
