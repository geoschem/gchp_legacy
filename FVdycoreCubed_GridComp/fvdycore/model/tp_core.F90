...
! Local:
  ...
  enddo
  if( ord < 0 ) then
      call xppm0(fx1, q_i, crx(is,js), ord, is, ie, js, je, npx, npy)
  else
      call   xtp(fx1, q_i, crx(is,js), ord, is, ie, js, je, npx, npy)
  endif
  ...
  enddo
  if ( ord < 0 ) then
      call yppm0(fy1, q_j, cry, ord, is, ie, js, je, npx, npy)
  else
      call   ytp(fy1, q_j, cry, ord, is, ie, js, je, npx, npy)
  endif
